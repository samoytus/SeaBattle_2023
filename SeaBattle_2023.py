        ...
        for ship in self.ships:
            if d in ship.dots:
                ...
                if ship.lives == 0:
                    ...
                    print(f"\033[32m Корабль потоплен!")
                    return False
                else:
                    print(f"\033[32m Попадание!")
                    return True

        self.field[d.x][d.y] = "."
        print(f"\033[31m Мимо!")
        return False
...
class AI(Player):
    def ask(self):
        ...
        print(f"\033[33m Ход компьютера: {d.x + 1} {d.y + 1}")
        return d
...
class User(Player):
    def ask(self):
        while True:
            cords = input("\033[35m Ваш ход:").split()

            if len(cords) != 2:
                print(f"\033[31m Введите 2 координаты! ")
                continue

            x, y = cords

            if not (x.isdigit()) or not (y.isdigit()):
                print(f"\033[31m Введите числа! ")
                continue
...
class Game:
    ...
    @staticmethod
    def fields_parallel(first, second):
    ...
    def loop(self):
        username = input(f"\033[35m Ваше имя: ")
        num = 0
        while True:
            print(Fore.BLUE + "-" * 60)
            ...
            if num % 2 == 0:
                print(Fore.BLUE + "-" * 60)
                print(f"\033[35m Ходит {username}!")
                repeat = self.us.move()
            else:
                print(Fore.BLUE + "-" * 60)
                print("\033[33m Ходит компьютер...")
                time.sleep(2)
                repeat = self.ai.move()
            if repeat:
                num -= 1
            ...
            if self.ai.board.count == 7:
                print(Fore.BLUE + "-" * 60)
                print(f"\033[32m {username} выиграл!")
                break

            if self.us.board.count == 7:
                print(Fore.BLUE + "-" * 60)
                print(f"\033[31m Компьютер выиграл!")
                break
            num += 1
